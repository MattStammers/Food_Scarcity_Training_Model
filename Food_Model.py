...
class simulation_model():
    def __init__(self):
        ...
        self.points = {
            'deathRate' :  [(0.0, 2.0), (0.2, 1.341), (0.4, 0.8987), (0.6, 0.6024), (0.8, 0.4038), (1.0, 0.2707), (1.2, 0.1814), (1.4, 0.1216), (1.6, 0.08152), (1.8, 0.05465), (2.0, 0.03663)]  , 
        }
        ...
        self.stocks = ['population'  ]
        self.flows = ['births',   'deaths'  ]
        self.converters = ['birthRate',   'foodAvailable',   'foodAvailablePerPerson'  ]
        self.gf = ['deathRate'  ]
        self.constants= []
        self.events = [
            ]
